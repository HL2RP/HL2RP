...
// Setup
	...
	virtual bool FShouldSwitchWeapon( CBasePlayer *pPlayer, CBaseCombatWeapon *pWeapon, bool wasCarried ) = 0;// should the player switch to this weapon?
...
// Client kills/scoring
	...
	virtual void DeathNotice( CBaseCombatCharacter *pVictim, const CTakeDamageInfo &info )=  0;// Call this from within a GameRules class to report an obituary.
...
// Weapon spawn/respawn control
	...
	virtual Vector VecWeaponRespawnSpot( CBaseCombatWeapon *pWeapon, QAngle& angles );// where in the world should this weapon respawn?
...
#ifdef HL2RP
	virtual bool CanPlayerHearVoice(CBasePlayer* pListener, CBasePlayer* pSpeaker, bool allTalk) { return true; }
#endif // HL2RP
