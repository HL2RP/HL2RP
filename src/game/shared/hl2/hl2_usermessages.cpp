...
#ifdef HL2RP_FULL
	usermessages->Register(HL2RP_KEY_HINT_USER_MESSAGE);
	usermessages->Register(HL2RP_PLAYER_NAME_SAVE_MESSAGE);
	usermessages->Register(HL2RP_PROPERTY_UPDATE_USER_MESSAGE);
	usermessages->Register(HL2RP_PROPERTY_GRANT_UPDATE_USER_MESSAGE);
	usermessages->Register(HL2RP_CITY_ZONE_UPDATE_MESSAGE);
#endif // HL2RP_FULL
}
