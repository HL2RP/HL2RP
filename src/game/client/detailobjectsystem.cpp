...
#if (defined DOD_DLL || defined CSTRIKE_DLL || defined HL2RP)
#define USE_DETAIL_SHAPES
#endif // (defined DOD_DLL || defined CSTRIKE_DLL || defined HL2RP)
...
{
	if (!m_DetailObjects.IsEmpty() || !m_DetailSpriteDict.IsEmpty())
	{
		C_World* pWorld = GetClientWorldEntity();
		const char* pDetailSpriteMaterial = (pWorld != NULL && pWorld->GetDetailSpriteMaterial() != NULL
			&& *pWorld->GetDetailSpriteMaterial() != '\0') ? pWorld->GetDetailSpriteMaterial() : DETAIL_SPRITE_MATERIAL;
