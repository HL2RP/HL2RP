...
public:
	...
	{ Q_strncpy( out_pOut, pIn, iLengthInChars ); }
...
public:
	...
	{ Q_wcsncpy( out_pOut, pIn, iLengthInChars * sizeof(wchar_t) ); }
	static void			  Copy( OUT_CAP(iLengthInChars) wchar_t *out_pOut, const char *pIn, int iLengthInChars )
	{ Q_UTF8ToUnicode( pIn, out_pOut, iLengthInChars * sizeof(wchar_t) ); }
