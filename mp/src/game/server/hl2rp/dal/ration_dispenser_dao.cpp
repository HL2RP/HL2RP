...
public:
	CDispensersLoadDAO()
	{
		mQueryDatabase.CreateCollection(RATION_DISPENSER_DAO_COLLECTION_NAME)
...
{
	CRecordNodeDTO* pDispenserData = pCollection->AddIndexField("map", STRING(gpGlobals->mapname));
