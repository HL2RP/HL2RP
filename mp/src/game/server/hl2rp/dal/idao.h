...
template<class T, ELevelInitDAOType priority>
...
public:
	CLevelInitDAOFactory() : ILevelInitDAOFactory(priority) {}
};
...
#define REGISTER_LEVEL_INIT_DAO_FACTORY(Class, priority) \
	static CLevelInitDAOFactory<Class, priority> s##Class##Factory;
